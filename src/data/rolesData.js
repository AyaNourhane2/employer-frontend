export const rolesData = {
    ...
    direction: {
      title: "Direction",
      description: "La direction supervise les opérations quotidiennes et prend des décisions stratégiques.",
      monthlyPayment: "5000 €",
      permissions: "Accès complet à tous les systèmes et données de l'entreprise.",
      holidayDays: "30 jours par an",
      restTime: "2 heures de pause par jour",
      color: "#6B5B95", // Couleur violette
    },
    "femmes-de-menage": {
